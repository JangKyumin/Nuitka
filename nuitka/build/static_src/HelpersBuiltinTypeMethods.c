...
#endif
#if PYTHON_VERSION >= 0x300
static PyObject *bytes_builtin_fromhex = NULL;
#endif
#if PYTHON_VERSION >= 0x300
...
#endif
#if PYTHON_VERSION >= 0x300
static PyObject *bytes_builtin_removeprefix = NULL;
#endif
#if PYTHON_VERSION >= 0x300
static PyObject *bytes_builtin_removesuffix = NULL;
#endif
#if PYTHON_VERSION >= 0x300
...
static void _initBytesBuiltinMethods(void) {
    ...
    bytes_builtin_fromhex = PyObject_GetAttrString((PyObject *)&PyBytes_Type, "fromhex");
    ...
    bytes_builtin_removeprefix = PyObject_GetAttrString((PyObject *)&PyBytes_Type, "removeprefix");
    bytes_builtin_removesuffix = PyObject_GetAttrString((PyObject *)&PyBytes_Type, "removesuffix");
